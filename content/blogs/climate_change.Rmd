...
In this section I will conduct an analysis of climate change. The data
has been collected by NASA's Goddard Institute for Space Studies. The
reference period for analysing the anomalies was set for 1951-1980.
...
The provided data gives us the information on the deviation of the
temperature from expected temperature for every month and year between
1880 and 2021.
